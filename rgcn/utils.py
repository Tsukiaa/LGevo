...
from ..rgcn import knowledge_graph as knwlgrh
...
def load_all_answers_for_time_filter_new(total_data, num_rels, num_nodes, rel_p=False):
    all_ans_list = []
    all_snap = total_data
...
def load_data(dataset, bfs_level=3, relabel=False):
    if dataset in ['aifb', 'mutag', 'bgs', 'am']:
        ...
        return knwlgrh.load_link(dataset)
                     ...
                     "WIKI", "MyData"]:
        return knwlgrh.load_from_local("DAO/models/My_ReGCN_model1/data", dataset)
    else:
